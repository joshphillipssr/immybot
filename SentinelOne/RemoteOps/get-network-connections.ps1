...
$filename = 'net-connections' # Default filename for output (without extension)
...
$scriptfunction = {
    ...
    $output = Get-NetTCPConnection | Select-Object -Property *  -ExcludeProperty CIM*, PSComputerName
