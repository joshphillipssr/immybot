...
$filename = 'usb-media' # Default filename for output (without extension)
...
$scriptfunction = {
    ...
    $output = Get-CimInstance -ClassName Win32_DiskDrive | Where-Object {$_.InterfaceType -eq 'USB'} | Select-Object * -ExcludeProperty CIM*, PSComputerName
