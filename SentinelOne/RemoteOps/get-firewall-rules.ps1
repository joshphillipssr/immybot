...
$filename = 'firewall-rules' # Default filename for output (without extension)
...
$scriptfunction = {
    ...
    $output = Get-NetFirewallRule | Select-Object -Property *  -ExcludeProperty CIM*, PSComputerName
