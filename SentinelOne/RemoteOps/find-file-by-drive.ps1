...
$filename = 'find-files' # Default filename for output (without extension)
...
$scriptfunction = {
    ...
    $output = Get-ChildItem -Path $path -Recurse -ErrorAction SilentlyContinue -Force | Where-Object Name -eq $file | Select-Object -Property * -ExcludeProperty PS*, Directory, VersionInfo
