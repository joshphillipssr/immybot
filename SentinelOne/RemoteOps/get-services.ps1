...
$filename = 'services' # Default filename for output (without extension)
...
$scriptfunction = {
    ...
    $output = Get-CIMInstance -Class Win32_Service | Select-Object * -ExcludeProperty CIM*, PSComputerName
