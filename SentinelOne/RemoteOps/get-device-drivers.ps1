...
$filename = 'device-drivers' # Default filename for output (without extension)
...
$scriptfunction = {
    ...
    $output = Get-CIMInstance -Class Win32_PnPSignedDriver| Select-Object * -ExcludeProperty CIM*, PSComputerName
