...
$filename = 'scheduled-tasks' # Default filename for output (without extension)
...
$scriptfunction = {
    ...
    $output = Get-ScheduledTask | Select-Object -Property * -ExcludeProperty CIM*, PSComputerName
