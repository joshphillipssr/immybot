...
$filename = 'show-wifi' # Default filename for output (without extension)
...
$scriptfunction = {
    ...
    function Get-WifiNetwork { # Based on https://www.fortypoundhead.com/showcontent.asp?artid=24189
        end {
